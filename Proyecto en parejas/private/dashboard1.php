...
<body class="admin">
  <header>
    <nav class="navbar">
      ...
      <a href="dashboard.php" class="moto">Coches</a>
  ...
  <main>
    ...
    <a href="../motos/create.php" class='button create'>Crear</a>
    <table>
        ...
        <tbody>
            ...
            foreach ($resultado as $row) {
                ...
                echo "<td> <a href='../motos/edit.php?id=".$row['id']."'class='button edit'>Editar</a>
                      <a href='../motos/delete.php?id=".$row['id']."'class='button delete'>Eliminar</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
